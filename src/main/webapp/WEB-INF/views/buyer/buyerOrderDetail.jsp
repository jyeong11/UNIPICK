...
<body>
	...
	<div id="delprice-container">
        ...
        <div class="price">
            <div id="total-pr"><span>총 상품금액</span><span id="totalPrice"></span></div>
            <div id="total-dp"><span>총 배송비</span><span id="totalDelPrice"></span></div>
        </div>
        <div id="prpr"><span>결제 예상 금액</span><span id="sum"></span>         	
        </div>
    </div>
