...
<link href="${pageContext.request.contextPath }/resources/css/buyer/buyerCategory.css" rel="stylesheet" type="text/css">
...
<script src="${pageContext.request.contextPath }/resources/js/buyer/buyerCategory.js"></script>
