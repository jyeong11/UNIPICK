	...
	<ul class="navbar-nav ml-auto">
		<li class="nav-item dropdown no-arrow"><a
			...
			<div
				...
				<a class="dropdown-item" href="main" target="_blank"> <svg
						class="svg-inline--fa fa-list fa-fw fa-sm mr-2 text-gray-400"
						aria-hidden="true" focusable="false" data-prefix="fas"
						data-icon="list" role="img" xmlns="http://www.w3.org/2000/svg"
