...
<!-- 페이지 전용 JS (외부 파일로 분리) -->
<script
	src="${pageContext.request.contextPath}/resources/js/seller/sellerVisitorStats.js"></script>
					...
					<div class="row">
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">일별 방문자 통계</h6>
								</div>
								<!-- 검색 필터 추가 -->
								<div class="row mb-4">
									<div class="col-12">
						...
						<div class="row mt-4">
							<div class="col-12">
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h6 class="m-0 font-weight-bold text-primary">상세 방문자 통계</h6>
									</div>
									<div class="card-body">
