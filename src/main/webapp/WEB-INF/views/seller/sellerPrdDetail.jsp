...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/seller/sellerPrdDetail.css"
	rel="stylesheet">
<!-- TOAST UI Editor -->
<link rel="stylesheet"
...
<!-- 페이지 전용 JS (외부 파일로 분리) -->
<script
	src="${pageContext.request.contextPath}/resources/js/seller/sellerPrdDetail.js"></script>
</head>
<body id="page-top">
	<div id="wrapper">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<section class="item-regi">
										<form action="productInsert" id="productUpdate" method="post"
													...
													<c:forEach var="i" begin="1" end="10">
														<div class="item-thumb">
															...
															<input type="file" class="item-thumb-upload-btn"
																id="item-thumb-upload-btn${i}" name="productData">
														</div>
													</c:forEach>
												</div>
											</section>
											...
											<section class="item-regi-section">
												...
												<div class="item-regi-box">
													<input type="text" name="product_code"
														class="item-regi-title-text readonly"
														id="item-regi-code-text" maxlength="50" readonly>
												</div>
												<h6 class="item-regi-code-byte" id="item-regi-code-byte">(0
													/ 50)</h6>
											</section>
											<section class="item-regi-section">
											...
											<div class="item-regi-submit-group">
												<input type="button" class="item-backpage"
													...
													type="submit" class="item-submit" id="update" value="상품 수정">
												<input type="button" class="item-delete" id="delete"
													value="상품 삭제">
											</div>
										</form>
									</section>
