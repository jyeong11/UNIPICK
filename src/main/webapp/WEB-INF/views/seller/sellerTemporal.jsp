...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 id="fa" class="m-0 font-weight-bold text-primary">일별 방문자 통계</h6>
                    <!-- 검색 필터 추가 -->
                    <div class="row mb-4">
                        <div class="col-12">
        ...
        <div class="col-xl-4 col-lg-5">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 id="fa" class="m-0 font-weight-bold text-primary">인기 상품</h6>
                </div>
                <div class="card-body">
                    <div class="chart-pie">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 id="fa" class="m-0 font-weight-bold text-primary">방문자별 방문 횟수</h6>
                </div>
                <div class="card-body">
                    <div class="chart-bar">
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 id="fa" class="m-0 font-weight-bold text-primary">상세 방문자 통계</h6>
                </div>
                <div class="card-body">
