...
<link
	...
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath }/resources/css/admin/admProductList.css"
...
<!-- script -->
<script
	src="${pageContext.request.contextPath }/resources/js/admin/admProductList.js"></script>
...
// 	console.log("현재 페이지 주소: " + window.location.pathname);
						...
						<div class="card-body">
							<div class="admProductList-top-div">
								<div class="search-div">
									...
									<div>
										<input type="text" id="ListSearchWord" placeholder="검색어로 조회">
									</div>
									<div>
										<button id="search"
							...
							<div class="modal fade" id="exampleModal" tabindex="-1"
								...
								<div id="modal" class="modal-dialog modal-xl" role="document">
									<div class="modal-content">
										<div class="modal-header">상품 - 상세조회</div>
	...
	<a class="scroll-to-top rounded" href="#page-top"> <svg
			class="svg-inline--fa fa-angle-up" aria-hidden="true"
			focusable="false" data-prefix="fas" data-icon="angle-up" role="img"
			xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
			data-fa-i2svg="">
			<path fill="currentColor"
				d="M201.4 137.4c12.5-12.5 32.8-12.5 45.3 0l160 160c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L224 205.3 86.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160z"></path></svg>
		<!-- <i class="fas fa-angle-up"></i> Font Awesome fontawesome.com -->
	</a>
